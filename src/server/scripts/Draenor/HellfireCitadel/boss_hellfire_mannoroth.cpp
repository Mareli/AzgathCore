...
struct boss_hellfire_mannoroth : public BossAI
{
    boss_hellfire_mannoroth(Creature* creature) : BossAI(creature, DATA_MANNOROTH) { Initialize(); }
...
{
    RegisterCreatureAI(boss_hellfire_mannoroth);
}
