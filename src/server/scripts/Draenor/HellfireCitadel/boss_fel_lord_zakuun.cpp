...
struct boss_fel_lord_zakuun : public BossAI
{
    boss_fel_lord_zakuun(Creature* creature) : BossAI(creature, DATA_FEL_LORD_ZAKUUN) { Initialize(); }
...
{
    RegisterCreatureAI(boss_fel_lord_zakuun);
}
