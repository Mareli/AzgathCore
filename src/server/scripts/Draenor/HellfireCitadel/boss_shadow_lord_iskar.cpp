...
struct boss_shadow_lord_iskar : public BossAI
{
    boss_shadow_lord_iskar(Creature* creature) : BossAI(creature, DATA_SHADOW_LORD_ISKAR) { Initialize(); }
...
{
    RegisterCreatureAI(boss_shadow_lord_iskar);
}
