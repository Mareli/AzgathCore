...
struct boss_hellfire_archimonde : public BossAI
{
    boss_hellfire_archimonde(Creature* creature) : BossAI(creature, DATA_HELLFIRE_ARCHIMONDE) { Initialize(); }
...
{
    RegisterCreatureAI(boss_hellfire_archimonde);
}
