#ifndef VALE_OF_ETERNAL_BLOSSOMS_H
#define VALE_OF_ETERNAL_BLOSSOMS_H
...
enum eEvents
{
    ...
    EVENT_CRUSHING_STOMP            = 2,
    EVENT_GROUND_STOMP              = 3,
    EVENT_PARALYZED                 = 4,
    EVENT_THUNDERING_SLAM           = 5,
    EVENT_STEALTH                   = 6,
    EVENT_RAIN_OF_SHADOW            = 7,
    EVENT_SHADOW_EMPOWERMENT        = 8,
    EVENT_SUCCUMB_TO_SHADOWS        = 9
};
