...
/*class AzgathCoreFreeRepackWelcome : public PlayerScript
{
public:
    AzgathCoreFreeRepackWelcome() : PlayerScript("AzgathCoreFreeRepackWelcome") { }
    ...
    {
        ChatHandler(player->GetSession()).SendSysMessage("|cffFF0000 This is AzgathCore Free Test Repack. Donate to remove ads and limitations|r");
        ChatHandler(player->GetSession()).SendSysMessage("|cffFF0000 AzgathCore official discord: https://discord.com/invite/U4pXKB2WNA |r");
        player->GetSession()->SendNotification("This is AzgathCore Free Test Repack. Donate to remove ads and limitations. AzgathCore official discord: https://discord.com/invite/U4pXKB2WNA");
    }
};*/
...
void AddSC_custom_player_script()
{
    ...
    //RegisterPlayerScript(AzgathCoreFreeRepackWelcome);
}
