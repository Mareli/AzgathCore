...
enum BG_BFG_NodeObjectId
{
    ...
    BG_BFG_OBJECTID_NODE_BANNER_1     = 228052, // Mine banner
    BG_BFG_OBJECTID_NODE_BANNER_2     = 228053  // Waterworks banner
};
...
enum BG_BFG_ObjectType
{
    ...
    //gates
    BG_BFG_OBJECT_GATE_A                    = 5,
    BG_BFG_OBJECT_GATE_H                    = 6,
    //buff
    BG_BFG_OBJECT_SPEEDBUFF_LIGHTHOUSE      = 7,
    BG_BFG_OBJECT_REGENBUFF_LIGHTHOUSE      = 8,
    BG_BFG_OBJECT_BERSERKBUFF_LIGHTHOUSE    = 9,
    BG_BFG_OBJECT_SPEEDBUFF_WATERWORKS      = 10,
    BG_BFG_OBJECT_REGENBUFF_WATERWORKS      = 11,
    BG_BFG_OBJECT_BERSERKBUFF_WATERWORKS    = 12,
    BG_BFG_OBJECT_SPEEDBUFF_MINE            = 13,
    BG_BFG_OBJECT_REGENBUFF_MINE            = 14,
    BG_BFG_OBJECT_BERSERKBUFF_MINE          = 15,
    BG_BFG_OBJECT_MAX                       = 16
};
...
enum BattleForGilneasBannerSpellVisual
{
    BFG_SPELL_VISUAL_NEUTRAL            = 42975,
    BFG_SPELL_VISUAL_HORDE_CONTESTED    = 42976,
    BFG_SPELL_VISUAL_ALLIANCE_CONTESTED = 42978,
    BFG_SPELL_VISUAL_HORDE_OCCUPIED     = 42979,
    BFG_SPELL_VISUAL_ALLIANCE_OCCUPIED  = 42980
};

enum BattleForGilneasWorldState
{
    BFG_NEUTRAL            = 0,
    BFG_HORDE_CONTESTED    = 2,
    BFG_ALLIANCE_CONTESTED = 3,
    BFG_HORDE_OCCUPIED     = 4,
    BFG_ALLIANCE_OCCUPIED  = 5
};
...
class BattlegroundBFGScore final : public BattlegroundScore
{
    ...
    protected:
        ...
        void BuildPvPLogPlayerDataPacket(WorldPackets::Battleground::PVPLogData::PVPMatchPlayerStatistics& playerData) const override
        {
            ...
            playerData.Stats.emplace_back(BFG_OBJECTIVE_ASSAULT_BASE, BasesAssaulted);
            playerData.Stats.emplace_back(BFG_OBJECTIVE_DEFEND_BASE, BasesDefended);
        }
...
class BattlegroundBFG : public Battleground
{
    ...
    private:
        ...
        */
        ...
        BattleForGilneasWorldState m_BannerWorldState[BG_BFG_DYNAMIC_NODES_COUNT];
