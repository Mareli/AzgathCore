...
(@CGUID+0, 29586, 571, 0, 0, '0', 0,  0, 0, 7049.645, -27.82183, 808.5272, 3.089233, 300, 0, 0, 0, 0, 0, 0, 0, 0, 23420), -- Stormforged Pillager (Area: -Unknown-)
(@CGUID+1, 29843, 571, 0, 0, '0', 0,  0, 0, 6995.886, -13.95654, 809.7472, 0.4717727, 300, 10, 0, 0, 0, 1, 0, 0, 0, 23420), -- Stormforged Loreseeker (Area: -Unknown-) (Auras: 12550 - Lightning Shield) (possible waypoints or random movement)
(@CGUID+2, 29586, 571, 0, 0, '0', 0,  0, 0, 6974.152, -17.91818, 809.2553, 0.2562811, 300, 10, 0, 0, 0, 1, 0, 0, 0, 23420), -- Stormforged Pillager (Area: -Unknown-) (possible waypoints or random movement)
(@CGUID+3, 29843, 571, 0, 0, '0', 0,  0, 0, 6984.833, -0.527235, 809.966, 0.03490658, 300, 0, 0, 0, 0, 0, 0, 0, 0, 23420), -- Stormforged Loreseeker (Area: -Unknown-) (Auras: 12550 - Lightning Shield)
(@CGUID+4, 29843, 571, 0, 0, '0', 0,  0, 0, 6953.073, -4.012344, 808.3405, 3.840379, 300, 0, 0, 0, 0, 0, 0, 0, 0, 23420), -- Stormforged Loreseeker (Area: Frostgrip's Hollow) (Auras: 12550 - Lightning Shield) (possible waypoints or random movement)
(@CGUID+5, 29843, 571, 0, 0, '0', 0,  0, 0, 7010.22, 61.93403, 812.8073, 1.53589, 300, 0, 0, 0, 0, 0, 0, 0, 0, 23420), -- Stormforged Loreseeker (Area: Frostgrip's Hollow) (Auras: 12550 - Lightning Shield)
(@CGUID+6, 29586, 571, 0, 0, '0', 0,  0, 0, 7011.019, 73.10926, 812.0643, 0.4426216, 300, 10, 0, 0, 0, 1, 0, 0, 0, 23420), -- Stormforged Pillager (Area: Frostgrip's Hollow) (possible waypoints or random movement)
(@CGUID+7, 29843, 571, 0, 0, '0', 0,  0, 0, 6926.479, -24.19451, 803.7806, 5.987985, 300, 10, 0, 0, 0, 1, 0, 0, 0, 23420), -- Stormforged Loreseeker (Area: Frostgrip's Hollow) (Auras: 12550 - Lightning Shield) (possible waypoints or random movement)
(@CGUID+8, 29586, 571, 0, 0, '0', 0,  0, 0, 6954.638, 55.05556, 816.7207, 0.122173, 300, 0, 0, 0, 0, 0, 0, 0, 0, 23420), -- Stormforged Pillager (Area: Frostgrip's Hollow)
(@CGUID+9, 29843, 571, 0, 0, '0', 0,  0, 0, 6921.624, 7.681424, 801.1466, 4.328416, 300, 0, 0, 0, 0, 0, 0, 0, 0, 23420), -- Stormforged Loreseeker (Area: Frostgrip's Hollow) (Auras: 12550 - Lightning Shield)
(@CGUID+10, 29586, 571, 0, 0, '0', 0, 0, 0, 6935.855, 40.69868, 796.5327, 3.473205, 300, 0, 0, 0, 0, 0, 0, 0, 0, 23420), -- Stormforged Pillager (Area: Frostgrip's Hollow)
(@CGUID+11, 29843, 571, 0, 0, '0', 0, 0, 0, 6919.627, 23.92171, 797.3717, 2.617994, 300, 0, 0, 0, 0, 0, 0, 0, 0, 23420), -- Stormforged Loreseeker (Area: Frostgrip's Hollow) (Auras: 12550 - Lightning Shield)
(@CGUID+12, 29843, 571, 0, 0, '0', 0, 0, 0, 6958.898, 77.93271, 811.8732, 5.014532, 300, 10, 0, 0, 0, 1, 0, 0, 0, 23420), -- Stormforged Loreseeker (Area: Frostgrip's Hollow) (Auras: 12550 - Lightning Shield) (possible waypoints or random movement)
(@CGUID+13, 29586, 571, 0, 0, '0', 0, 0, 0, 6905.328, -12.22879, 801.8771, 0.4363323, 300, 0, 0, 0, 0, 0, 0, 0, 0, 23420), -- Stormforged Pillager (Area: Frostgrip's Hollow)
(@CGUID+14, 29843, 571, 0, 0, '0', 0, 0, 0, 6896.476, 14.36659, 797.7606, 0.5759587, 300, 0, 0, 0, 0, 0, 0, 0, 0, 23420), -- Stormforged Loreseeker (Area: Frostgrip's Hollow) (Auras: 12550 - Lightning Shield)
(@CGUID+15, 29843, 571, 0, 0, '0', 0, 0, 0, 6912.183, 53.53537, 797.6075, 4.014257, 300, 0, 0, 0, 0, 0, 0, 0, 0, 23420), -- Stormforged Loreseeker (Area: Frostgrip's Hollow) (Auras: 12550 - Lightning Shield)
(@CGUID+16, 29586, 571, 0, 0, '0', 0, 0, 0, 6944.983, 109.52, 811.0266, 5.061455, 300, 0, 0, 0, 0, 0, 0, 0, 0, 23420), -- Stormforged Pillager (Area: Frostgrip's Hollow)
(@CGUID+17, 29586, 571, 0, 0, '0', 0, 0, 0, 6886.117, 65.42665, 794.3042, 4.764749, 300, 0, 0, 0, 0, 0, 0, 0, 0, 23420), -- Stormforged Pillager (Area: Frostgrip's Hollow)
(@CGUID+18, 29843, 571, 0, 0, '0', 0, 0, 0, 6879.436, 35.18378, 795.2526, 0.8566515, 300, 0, 0, 0, 0, 0, 0, 0, 0, 23420), -- Stormforged Loreseeker (Area: Frostgrip's Hollow) (Auras: 12550 - Lightning Shield)
(@CGUID+19, 29843, 571, 0, 0, '0', 0, 0, 0, 7007.188, -8.436795, 807.9281, 2.792527, 300, 10, 0, 0, 0, 1, 0, 0, 0, 23420), -- Stormforged Loreseeker (Area: Frostgrip's Hollow) (Auras: 12550 - Lightning Shield) (possible waypoints or random movement)
(@CGUID+20, 29586, 571, 0, 0, '0', 0, 0, 0, 6989.952, -16.83491, 809.6952, 3.08325, 300, 10, 0, 0, 0, 1, 0, 0, 0, 23420), -- Stormforged Pillager (Area: Frostgrip's Hollow) (possible waypoints or random movement)
(@CGUID+21, 29843, 571, 0, 0, '0', 0, 0, 0, 6984.833, -0.527235, 809.966, 0.03490658, 300, 0, 0, 0, 0, 0, 0, 0, 0, 23420), -- Stormforged Loreseeker (Area: Frostgrip's Hollow) (Auras: 12550 - Lightning Shield)
(@CGUID+22, 29843, 571, 0, 0, '0', 0, 0, 0, 6912.183, 53.53537, 797.6075, 4.014257, 300, 0, 0, 0, 0, 0, 0, 0, 0, 23420), -- Stormforged Loreseeker (Area: Frostgrip's Hollow) (Auras: 12550 - Lightning Shield)
(@CGUID+23, 29586, 571, 0, 0, '0', 0, 0, 0, 6886.117, 65.42665, 794.3042, 4.764749, 300, 0, 0, 0, 0, 0, 0, 0, 0, 23420), -- Stormforged Pillager (Area: Frostgrip's Hollow)
(@CGUID+24, 29843, 571, 0, 0, '0', 0, 0, 0, 6989.167, 68.96354, 821.4493, 3.979351, 300, 0, 0, 0, 0, 0, 0, 0, 0, 23420), -- Stormforged Loreseeker (Area: Frostgrip's Hollow) (Auras: 12550 - Lightning Shield)
(@CGUID+25, 29843, 571, 0, 0, '0', 0, 0, 0, 7010.22, 61.93403, 812.8073, 1.53589, 300, 0, 0, 0, 0, 0, 0, 0, 0, 23420), -- Stormforged Loreseeker (Area: Frostgrip's Hollow) (Auras: 12550 - Lightning Shield)
(@CGUID+26, 29586, 571, 0, 0, '0', 0, 0, 0, 7049.645, -27.82183, 808.5272, 3.089233, 300, 0, 0, 0, 0, 0, 0, 0, 0, 23420); -- Stormforged Pillager (Area: Frostgrip's Hollow)
