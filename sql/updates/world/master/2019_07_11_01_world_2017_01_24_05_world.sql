...
(@CGUID+0, 29323, 571, 0, 0, '0', 0, 0, 1, 6968.38, -1036.38, 804.849, 4.32326, 300, 0, 0, 12175, 0, 0, 0, 0, 0, 0),
(@CGUID+1, 29323, 571, 0, 0, '0', 0, 0, 1, 6889.61, -1141.36, 802.432, 1.72516, 300, 0, 0, 12175, 0, 0, 0, 0, 0, 0),
(@CGUID+2, 29323, 571, 0, 0, '0', 0, 0, 1, 6610.21, -1084.88, 762.207, 0.786112, 300, 0, 0, 11770, 0, 0, 0, 0, 0, 0),
(@CGUID+3, 29323, 571, 0, 0, '0', 0, 0, 1, 6587.2, -1059.6, 748.807, 3.08891, 300, 0, 0, 12175, 0, 0, 0, 0, 0, 0),
(@CGUID+4, 29323, 571, 0, 0, '0', 0, 0, 1, 6599.12, -1111.81, 748.803, 3.4659, 300, 0, 0, 12175, 0, 0, 0, 0, 0, 0),
(@CGUID+5, 29331, 571, 0, 0, '0', 0, 0, 1, 6697.06, -1062.14, 764.093, 3.33207, 300, 0, 0, 9740, 8636, 0, 0, 0, 0, 0),
(@CGUID+6, 29323, 571, 0, 0, '0', 0, 0, 1, 6624.12, -1086.51, 748.602, 2.78313, 300, 0, 0, 11770, 0, 0, 0, 0, 0, 0),
(@CGUID+7, 29466, 571, 0, 0, '0', 0, 0, 0, 6618.3, -1104.94, 748.305, 3.52847, 300, 0, 0, 12175, 0, 0, 0, 0, 0, 0);

-- Add one missing Cage
SET @OGUID := 44; -- GUID 42 used at master
...
(@OGUID, 191544, 571, 67, 4423, '0', 0, 6618.3, -1104.94, 748.305, 3.52847, 0, 0, 0.981349, -0.192237, 300, 0, 1, 0);
