...
ALTER TABLE `adventure_journal_locale`
  DROP PRIMARY KEY,
  ADD PRIMARY KEY (`ID`,`locale`,`VerifiedBuild`),
  DROP INDEX `idx_locale`,
  ENGINE=InnoDB
...
ALTER TABLE `battle_pet_ability_state`
  DROP PRIMARY KEY,
  ADD PRIMARY KEY (`ID`,`VerifiedBuild`),
  ENGINE=InnoDB;

ALTER TABLE `battle_pet_ability_turn`
  DROP PRIMARY KEY,
  ADD PRIMARY KEY (`ID`,`VerifiedBuild`),
  ENGINE=InnoDB;

ALTER TABLE `garr_follower_level_x_p`
  DROP PRIMARY KEY,
  ADD PRIMARY KEY (`ID`,`VerifiedBuild`),
  ENGINE=InnoDB;

ALTER TABLE `garr_follower_quality`
  DROP PRIMARY KEY,
  ADD PRIMARY KEY (`ID`,`VerifiedBuild`),
  ENGINE=InnoDB;

ALTER TABLE `garr_follower_type`
  DROP PRIMARY KEY,
  ADD PRIMARY KEY (`ID`,`VerifiedBuild`),
  ENGINE=InnoDB;
...
ALTER TABLE `garr_mission_locale`
  DROP PRIMARY KEY,
  ADD PRIMARY KEY (`ID`,`locale`,`VerifiedBuild`),
  DROP INDEX `idx_locale`,
  ENGINE=InnoDB
...
ALTER TABLE `global_strings`
  DROP PRIMARY KEY,
  ADD PRIMARY KEY (`ID`,`VerifiedBuild`),
  ENGINE=InnoDB;

ALTER TABLE `global_strings_locale`
  DROP PRIMARY KEY,
  ADD PRIMARY KEY (`ID`,`locale`,`VerifiedBuild`),
  DROP INDEX `idx_locale`,
  ENGINE=InnoDB
...
ALTER TABLE `journal_encounter`
  DROP PRIMARY KEY,
  ADD PRIMARY KEY (`ID`,`VerifiedBuild`),
  ENGINE=InnoDB;

ALTER TABLE `journal_encounter_locale`
  DROP PRIMARY KEY,
  ADD PRIMARY KEY (`ID`,`locale`,`VerifiedBuild`),
  DROP INDEX `idx_locale`,
  ENGINE=InnoDB
...
ALTER TABLE `map_challenge_mode_locale`
  DROP PRIMARY KEY,
  ADD PRIMARY KEY (`ID`,`locale`,`VerifiedBuild`),
  DROP INDEX `idx_locale`,
  ENGINE=InnoDB
...
ALTER TABLE `quest_v2_cli_task_locale`
  DROP PRIMARY KEY,
  ADD PRIMARY KEY (`ID`,`locale`,`VerifiedBuild`),
  DROP INDEX `idx_locale`,
  ENGINE=InnoDB
...
ALTER TABLE `research_branch_locale`
  DROP PRIMARY KEY,
  ADD PRIMARY KEY (`Id`,`VerifiedBuild`),
  ENGINE=InnoDB;
...
ALTER TABLE `research_project_locale`
  DROP PRIMARY KEY,
  ADD PRIMARY KEY (`ID`,`locale`,`VerifiedBuild`),
  DROP INDEX `idx_locale`,
  ENGINE=InnoDB
...
ALTER TABLE `research_site_locale`
  DROP PRIMARY KEY,
  ADD PRIMARY KEY (`ID`,`locale`,`VerifiedBuild`),
  DROP INDEX `idx_locale`,
  ENGINE=InnoDB
...
ALTER TABLE `battle_pet_ability`
  DROP PRIMARY KEY,
  ADD PRIMARY KEY (`ID`,`VerifiedBuild`),
  ENGINE=InnoDB;

ALTER TABLE `battle_pet_ability_locale`
  DROP PRIMARY KEY,
  ADD PRIMARY KEY (`ID`,`locale`,`VerifiedBuild`),
  DROP INDEX `idx_locale`,
  ENGINE=InnoDB
