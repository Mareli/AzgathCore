...
ALTER TABLE `adventure_journal` CHARACTER SET=utf8mb4, COLLATE=utf8mb4_unicode_ci;
ALTER TABLE `adventure_journal` MODIFY COLUMN `Name` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `ID`;
ALTER TABLE `adventure_journal` MODIFY COLUMN `Description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `Name`;
ALTER TABLE `adventure_journal` MODIFY COLUMN `ButtonText` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `Description`;
ALTER TABLE `adventure_journal` MODIFY COLUMN `RewardDescription` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `ButtonText`;
ALTER TABLE `adventure_journal` MODIFY COLUMN `ContinueDescription` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `RewardDescription`;


ALTER TABLE `adventure_journal_locale` CHARACTER SET=utf8mb4, COLLATE=utf8mb4_unicode_ci;
ALTER TABLE `adventure_journal_locale` MODIFY COLUMN `locale` varchar(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL AFTER `ID`;
ALTER TABLE `adventure_journal_locale` MODIFY COLUMN `Name_lang` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `locale`;
ALTER TABLE `adventure_journal_locale` MODIFY COLUMN `Description_lang` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `Name_lang`;
ALTER TABLE `adventure_journal_locale` MODIFY COLUMN `ButtonText_lang` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `Description_lang`;
ALTER TABLE `adventure_journal_locale` MODIFY COLUMN `RewardDescription_lang` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `ButtonText_lang`;
ALTER TABLE `adventure_journal_locale` MODIFY COLUMN `ContinueDescription_lang` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `RewardDescription_lang`;
ALTER TABLE `adventure_journal_locale` ADD INDEX `idx_locale`(`locale`);

ALTER TABLE `battle_pet_ability_effect` CHARACTER SET=utf8mb4, COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `battle_pet_ability_state` CHARACTER SET=utf8mb4, COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `battle_pet_ability_turn` CHARACTER SET=utf8mb4, COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `garr_follower_level_x_p` CHARACTER SET=utf8mb4, COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `garr_follower_quality` CHARACTER SET=utf8mb4, COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `garr_follower_type` CHARACTER SET=utf8mb4, COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `garr_mission_locale` CHARACTER SET=utf8mb4, COLLATE=utf8mb4_unicode_ci;
ALTER TABLE `garr_mission_locale` MODIFY COLUMN `locale` varchar(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL AFTER `ID`;
ALTER TABLE `garr_mission_locale` MODIFY COLUMN `Name_lang` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `locale`;
ALTER TABLE `garr_mission_locale` MODIFY COLUMN `Description_lang` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `Name_lang`;
ALTER TABLE `garr_mission_locale` MODIFY COLUMN `Location_lang` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `Description_lang`;
ALTER TABLE `garr_mission_locale` ADD INDEX `idx_locale`(`locale`);

ALTER TABLE `garr_mission` CHARACTER SET=utf8mb4, COLLATE=utf8mb4_unicode_ci;
ALTER TABLE `garr_mission` MODIFY COLUMN `Name` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL;
ALTER TABLE `garr_mission` MODIFY COLUMN `Description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `Name`;
ALTER TABLE `garr_mission` MODIFY COLUMN `Location` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `Description`;

ALTER TABLE `global_strings_locale` CHARACTER SET=utf8mb4, COLLATE=utf8mb4_unicode_ci;
ALTER TABLE `global_strings_locale` MODIFY COLUMN `locale` varchar(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL AFTER `ID`;
ALTER TABLE `global_strings_locale` MODIFY COLUMN `StringValue_lang` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `locale`;
ALTER TABLE `global_strings_locale` ADD INDEX `idx_locale`(`locale`);

ALTER TABLE `global_strings` CHARACTER SET=utf8mb4, COLLATE=utf8mb4_unicode_ci;
ALTER TABLE `global_strings` MODIFY COLUMN `StringName` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL AFTER `ID`;
ALTER TABLE `global_strings` MODIFY COLUMN `StringValue` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `StringName`;

ALTER TABLE `journal_encounter_locale` CHARACTER SET=utf8mb4, COLLATE=utf8mb4_unicode_ci;
ALTER TABLE `journal_encounter_locale` MODIFY COLUMN `locale` varchar(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL AFTER `ID`;
ALTER TABLE `journal_encounter_locale` MODIFY COLUMN `Name_lang` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `locale`;
ALTER TABLE `journal_encounter_locale` MODIFY COLUMN `Description_lang` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `Name_lang`;
ALTER TABLE `journal_encounter_locale` ADD INDEX `idx_locale`(`locale`);

ALTER TABLE `journal_encounter` CHARACTER SET=utf8mb4, COLLATE=utf8mb4_unicode_ci;
ALTER TABLE `journal_encounter` MODIFY COLUMN `Name` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `ID`;
ALTER TABLE `journal_encounter` MODIFY COLUMN `Description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `Name`;

ALTER TABLE `map_challenge_mode_locale` CHARACTER SET=utf8mb4, COLLATE=utf8mb4_unicode_ci;
ALTER TABLE `map_challenge_mode_locale` MODIFY COLUMN `locale` varchar(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL AFTER `ID`;
ALTER TABLE `map_challenge_mode_locale` MODIFY COLUMN `Name_lang` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `locale`;
ALTER TABLE `map_challenge_mode_locale` ADD INDEX `idx_locale`(`locale`);

ALTER TABLE `map_challenge_mode` CHARACTER SET=utf8mb4, COLLATE=utf8mb4_unicode_ci;
ALTER TABLE `map_challenge_mode` MODIFY COLUMN `Name` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL;

ALTER TABLE `quest_v2_cli_task_locale` CHARACTER SET=utf8mb4, COLLATE=utf8mb4_unicode_ci;
ALTER TABLE `quest_v2_cli_task_locale` MODIFY COLUMN `locale` varchar(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL AFTER `ID`;
ALTER TABLE `quest_v2_cli_task_locale` MODIFY COLUMN `QuestTitle_lang` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `locale`;
ALTER TABLE `quest_v2_cli_task_locale` MODIFY COLUMN `BulletText_lang` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `QuestTitle_lang`;
ALTER TABLE `quest_v2_cli_task_locale` ADD INDEX `idx_locale`(`locale`);

ALTER TABLE `quest_v2_cli_task` CHARACTER SET=utf8mb4, COLLATE=utf8mb4_unicode_ci;
ALTER TABLE `quest_v2_cli_task` MODIFY COLUMN `QuestTitle` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `FiltRaces`;
ALTER TABLE `quest_v2_cli_task` MODIFY COLUMN `BulletText` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `QuestTitle`;

ALTER TABLE `quest_poi_blob` CHARACTER SET=utf8mb4, COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `quest_poi_point` CHARACTER SET=utf8mb4, COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `research_branch_locale` CHARACTER SET=utf8mb4, COLLATE=utf8mb4_unicode_ci;
ALTER TABLE `research_branch_locale` MODIFY COLUMN `locale` varchar(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL AFTER `ID`;
ALTER TABLE `research_branch_locale` MODIFY COLUMN `Name_lang` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `locale`;
ALTER TABLE `research_branch_locale` ADD INDEX `idx_locale`(`locale`);

ALTER TABLE `research_branch` CHARACTER SET=utf8mb4, COLLATE=utf8mb4_unicode_ci;
ALTER TABLE `research_branch` MODIFY COLUMN `Name` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `Id`;

ALTER TABLE `research_project_locale` CHARACTER SET=utf8mb4, COLLATE=utf8mb4_unicode_ci;
ALTER TABLE `research_project_locale` MODIFY COLUMN `locale` varchar(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL AFTER `ID`;
ALTER TABLE `research_project_locale` MODIFY COLUMN `Name_lang` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `locale`;
ALTER TABLE `research_project_locale` MODIFY COLUMN `Description_lang` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `Name_lang`;
ALTER TABLE `research_project_locale` ADD INDEX `idx_locale`(`locale`);

ALTER TABLE `research_project` CHARACTER SET=utf8mb4, COLLATE=utf8mb4_unicode_ci;
ALTER TABLE `research_project` MODIFY COLUMN `Name` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL;
ALTER TABLE `research_project` MODIFY COLUMN `Description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `Name`;

ALTER TABLE `research_site_locale` CHARACTER SET=utf8mb4, COLLATE=utf8mb4_unicode_ci;
ALTER TABLE `research_site_locale` MODIFY COLUMN `locale` varchar(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL AFTER `ID`;
ALTER TABLE `research_site_locale` MODIFY COLUMN `Name_lang` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `locale`;
ALTER TABLE `research_site_locale` ADD INDEX `idx_locale`(`locale`);

ALTER TABLE `research_site` CHARACTER SET=utf8mb4, COLLATE=utf8mb4_unicode_ci;
ALTER TABLE `research_site` MODIFY COLUMN `Name` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `Id`;

ALTER TABLE `battle_pet_ability_locale` CHARACTER SET=utf8mb4, COLLATE=utf8mb4_unicode_ci;
ALTER TABLE `battle_pet_ability_locale` MODIFY COLUMN `locale` varchar(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL AFTER `ID`;
ALTER TABLE `battle_pet_ability_locale` MODIFY COLUMN `Name_lang` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `locale`;
ALTER TABLE `battle_pet_ability_locale` MODIFY COLUMN `Description_lang` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `Name_lang`;
ALTER TABLE `battle_pet_ability_locale` ADD INDEX `idx_locale`(`locale`);

ALTER TABLE `battle_pet_ability` CHARACTER SET=utf8mb4, COLLATE=utf8mb4_unicode_ci;
ALTER TABLE `battle_pet_ability` MODIFY COLUMN `Name` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `ID`;
ALTER TABLE `battle_pet_ability` MODIFY COLUMN `Description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER `Name`;
