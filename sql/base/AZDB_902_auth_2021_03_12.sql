...
insert  into `account`(`id`,`username`,`salt`,`verifier`,`session_key_auth`,`session_key_bnet`,`sha_pass_hash`,`v`,`s`,`email`,`joindate`,`last_ip`,`failed_logins`,`locked`,`lock_country`,`last_login`,`online`,`EXPANSION`,`mutetime`,`locale`,`os`,`recruiter`,`recruiter_rewarded`,`battlenet_account`,`battlenet_index`,`mutereason`,`muteby`,`AtAuthFlag`,`coins`,`hwid`,`reg_mail`,`last_attempt_ip`) values 
...
CREATE TABLE `battlenet_accounts` (
  ...
  `battlePayCredits` int(10) unsigned DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='Account System';

/*Data for the table `battlenet_accounts` */

insert  into `battlenet_accounts`(`id`,`email`,`sha_pass_hash`,`joindate`,`last_ip`,`failed_logins`,`locked`,`lock_country`,`last_login`,`online`,`locale`,`os`,`LastCharacterUndelete`,`LoginTicket`,`LoginTicketExpiry`,`battlePayCredits`) values 
...
/*Table structure for table `battlepay_purchases` */
...
/*Data for the table `battlepay_purchases` */
...
(36294,9,0,2,NULL,NULL,'',NULL,NULL,NULL),
(36322,9,0,1,NULL,NULL,'D45684591C5088F8CF8CCB109BE7ABA9',NULL,NULL,NULL),
(36532,9,0,2,NULL,NULL,'',NULL,NULL,NULL),
(36753,9,0,2,NULL,NULL,'63DDC2A35BBAED2CDEF476FA8CE97051',NULL,NULL,NULL),
...
(2011,'Command: reload player_choice'),
(2012,'Command: mod credit'),
(2013,'Command: debug send playspellvisualkit');
...
(1,'ShadowCore 9.0.2','127.0.0.1','127.0.0.1','255.255.255.0',8085,0,2,1,0,0,37474,1,1);
