...
MySQL - 10.5.4-MariaDB : Database - az_auth
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`az_auth` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `account` (
  ...
  UNIQUE KEY `uk_bnet_acc` (`battlenet_account`,`battlenet_index`) USING BTREE,
...
CREATE TABLE `logs_ip_actions` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Used to log ips of individual actions';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Account-Permission relation';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Default permission to assign to different account security levels';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Permission - Linked Permission relation';
...
CREATE TABLE `rbac_permissions` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Permission List';
...
(1,'AzgathCore','127.0.0.1','127.0.0.1','255.255.255.0',8085,0,2,1,0,0,35435,1,1);
...
('2020_02_25_00_auth.sql','0ACDD35EC9745231BCFA701B78056DEF94D0CC53','RELEASED','2020-02-25 16:51:04',54),
('2020_03_03_00_auth.sql','F473DFEABAC661704ECEA3D72E93A3280122CA30','RELEASED','2020-03-03 22:49:13',54),
('2020_02_24_00_auth.sql','47E22129056EFD8B67754506231BCC4B0DDA6930','RELEASED','2020-04-19 11:56:24',51),
('2020_03_20_00_auth.sql','0F72572D7792236D8F1E556D9EC62352A0A149CA','RELEASED','2020-04-19 11:56:24',53),
('2020_03_23_00_auth.sql','B90D27BB8E3CEDF65881BDA0C7CE6FBC5EF310E0','RELEASED','2020-04-19 11:56:24',52),
('2020_03_31_00_auth.sql','BA82A58E95730A397922B6723DA027986E6CD535','RELEASED','2020-04-19 11:56:24',41),
('2020_04_04_00_auth.sql','5F118989A9F8AFA3B2065AB9C2C0BB7D9A0EB97A','RELEASED','2020-04-19 11:56:24',52),
('2020_06_04_00_auth.sql','BA797B558196B1A07F8FF66E5288AD04659CF6AC','RELEASED','2020-06-04 09:57:07',0),
('2020_06_17_00_auth.sql','8BAB0BF5C90EBDE68685A9FB772EA90DD214E6D6','RELEASED','2020-06-17 09:56:25',0);
...
(1,1582637685,0,0,'AzgathCore rev. a5e874af970f 2020-02-25 13:37:24 +0300 (warning_fix branch) (Win64, Release, Static)');
