...
CREATE TABLE `battlenet_accounts`  (
  ...
  `battlePayCredits` int(10) UNSIGNED NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'Account System' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for battlepay_purchases
-- ----------------------------
...
CREATE TABLE `battlepay_purchases`  (
  ...
  `RemoteAddress` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL
...
INSERT INTO `build_info` VALUES (36294, 9, 0, 2, NULL, NULL, '', NULL, NULL, NULL);
INSERT INTO `build_info` VALUES (36322, 9, 0, 1, NULL, NULL, 'D45684591C5088F8CF8CCB109BE7ABA9', NULL, NULL, NULL);
INSERT INTO `build_info` VALUES (36532, 9, 0, 2, NULL, NULL, '', NULL, NULL, NULL);
INSERT INTO `build_info` VALUES (36753, 9, 0, 2, NULL, NULL, '63DDC2A35BBAED2CDEF476FA8CE97051', NULL, NULL, NULL);
...
INSERT INTO `build_info` VALUES (37474, 9, 0, 2, NULL, NULL, '0DE685BBB0551086E7FBDC0B4BB06A5B', NULL, NULL, NULL);
...
INSERT INTO `rbac_linked_permissions` VALUES (192, 2011);
INSERT INTO `rbac_linked_permissions` VALUES (192, 2012);
INSERT INTO `rbac_linked_permissions` VALUES (192, 2013);
...
INSERT INTO `rbac_permissions` VALUES (2011, 'Command: reload player_choice');
INSERT INTO `rbac_permissions` VALUES (2012, 'Command: mod credit');
INSERT INTO `rbac_permissions` VALUES (2013, 'Command: debug send playspellvisualkit');
...
-- ----------------------------
INSERT INTO `realmlist` VALUES (1, 'Az\'gathCore 9.0.2', '127.0.0.1', '127.0.0.1', '255.255.255.0', 8085, 0, 2, 1, 0, 0, 37474, 1, 1);
