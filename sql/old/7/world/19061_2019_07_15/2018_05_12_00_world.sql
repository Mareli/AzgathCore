...
DELETE FROM `creature` WHERE `guid`=452771;
...
(452771, 92870, 643, 5004, 5004, 3, 169, 0, 0, 0, -508.3617, 804.9224, 266.9508, 0.02312139, 7200, 0, 0, 0, 0, 0, 0, 0, 0, 26365); -- Sindragosa's Fury (Area: Throne of the Tides - Difficulty: 2)
...
SET @OGUID:=235566;
DELETE FROM `gameobject` WHERE `guid` BETWEEN @OGUID+0 AND @OGUID+775;
INSERT INTO `gameobject` (`guid`, `id`, `map`, `zoneId`, `areaId`, `spawnMask`, `PhaseId`, `PhaseGroup`, `position_x`, `position_y`, `position_z`, `orientation`, `rotation0`, `rotation1`, `rotation2`, `rotation3`, `spawntimesecs`, `animprogress`, `state`, `VerifiedBuild`) VALUES
(@OGUID+0, 214517, 643, 5004, 5004, 3, 169, 0, -647.283, 806.7465, 249.3488, 0, 0, 0, 0, 1, 7200, 255, 1, 26365), -- Instance Portal (Party + Heroic) (Area: Throne of the Tides - Difficulty: 2)
...
DELETE FROM `gossip_menu_option` WHERE (`MenuId`=11469 AND `OptionIndex`=0);
