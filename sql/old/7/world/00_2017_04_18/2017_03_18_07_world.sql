...
(2144,9,0, 'Monk',0,1,1,13861,606,0,0, '',0,23420),
...
-- Ironforge Points of Interest Update master
...
DELETE FROM `points_of_interest` WHERE `ID`=606;
...
(606,-4849.077,-867.3924,7,99,0, 'Ironforge Monk Trainer',23420);
