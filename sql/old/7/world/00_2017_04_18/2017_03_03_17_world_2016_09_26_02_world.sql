...
(@CGUID+00,23472,601,6,0,530.495 ,597.0955,777.2634,5.986479 ,0,0,0),
(@CGUID+01,23472,601,6,0,530.6029,596.997 ,777.2633,5.427974 ,0,0,0),
(@CGUID+02,23472,601,6,0,530.7466,596.745 ,777.2631,2.303835 ,0,0,0),
(@CGUID+03,23472,601,6,0,583.0908,617.371 ,771.5508,0.6457718,0,0,0),
(@CGUID+04,23472,601,6,0,480.0325,615.5892,773.3531,4.101524 ,0,0,0),
(@CGUID+05,23472,601,6,0,581.4475,608.8407,739.4051,1.727876 ,0,0,0);
...
DELETE FROM `criteria_data` WHERE `criteria_id`=4244;
INSERT INTO `criteria_data` (`criteria_id`,`type`,`ScriptName`) VALUES
...
INSERT INTO `creature` (`guid`,`id`,`map`,`spawnMask`,`PhaseId`,`position_x`,`position_y`,`position_z`,`orientation`,`spawntimesecs`,`spawndist`,`movementtype`) VALUES
(@CGUID+06,22515,601,6,0,478.7393,252.8498,250.5435,0.05235988,0,0,0),
(@CGUID+07,22515,601,6,0,621.319 ,268.4819,250.5435,3.333579  ,0,0,0),
(@CGUID+08,22515,601,6,0,622.9042,252.945 ,250.5435,3.124139  ,0,0,0),
(@CGUID+09,22515,601,6,0,478.1486,269.0094,250.5435,6.126106  ,0,0,0),
(@CGUID+10,22515,601,6,0,478.5473,297.0447,250.5435,5.7944933 ,0,0,0),
(@CGUID+11,22515,601,6,0,478.2909,224.8265,250.2346,0.4014257 ,0,0,0),
(@CGUID+12,22515,601,6,0,620.6218,298.2625,250.5435,3.700098  ,0,0,0),
(@CGUID+13,22515,601,6,0,620.7037,224.5618,250.2321,2.530727  ,0,0,0);
