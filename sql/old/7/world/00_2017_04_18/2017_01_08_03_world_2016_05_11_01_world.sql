ALTER TABLE `spell_proc`
  ...
  CHANGE `spellFamilyMask3` `SpellFamilyMask3` int(10) unsigned NOT NULL DEFAULT 0 AFTER `SpellFamilyMask2`,
  CHANGE `typeMask` `ProcFlags` int(10) unsigned NOT NULL DEFAULT 0 AFTER `SpellFamilyMask3`,
