...
(2343,9,0, 'Monk',0,1,1,13866,605,0,0, '',0,23420);

-- Darnassus Points of Interest Update Master
...
DELETE FROM `points_of_interest` WHERE `ID` IN (605);
...
(605,9845.986,2460.844,7,99,0, 'Darnassus Monk Trainer',23420);
