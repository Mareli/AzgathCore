...
(109385,1093850,0);
DELETE FROM `creature` WHERE `guid` IN (109404,109385, 113, 114); -- 4.x guids
...
(113,27024,571,4676.16,-5575.82,53.61,0.85,120,6,9940,0,2),
(114,26935,571,4550.15,-5493.45,2.19,0.85,120,6,9940,0,2);
