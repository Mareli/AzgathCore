...
-- DELETE FROM `creature_ai_scripts` WHERE `creature_id`=25789; 4.x
...
-- UPDATE `item_template` SET `flagsCustom`=flagsCustom|2 WHERE `entry`=18706; 4.x - Not in item_template
...
-- UPDATE `item_template` SET `DisenchantID`=41 WHERE `entry` IN (51964, 51968, 51978, 51994); 4.x removed
...
-- UPDATE `gameobject` SET `id` = 180669 WHERE `guid` = 99900; 4.x removed
