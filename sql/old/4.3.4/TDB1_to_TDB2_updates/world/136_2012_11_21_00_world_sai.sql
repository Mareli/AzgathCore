SET @GOGUID := 20; -- need 1 set by TDB - 4.x
...
-- DELETE FROM `creature` WHERE `guid` IN (43494,43496,43498,43501); -- double spawned - 4.x no such guids
-- DELETE FROM `gameobject` WHERE `guid`=364; -- double spawned - 4.x no guid "364"
