...
UPDATE `creature_classlevelstats` SET `basehp0`=4299, `basehp3`=61992, `basemana`=9697 WHERE `level`=85 AND `class`=8;
UPDATE `creature_classlevelstats` SET `basehp3`=68714, `basemana`=10232 WHERE `level`=88 AND `class`=8;
