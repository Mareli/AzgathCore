DELETE FROM `gameobject` WHERE `guid` IN (5, 78);
INSERT INTO `gameobject` (`guid`, `id`, `map`, `spawnMask`, `phaseMask`, `position_x`, `position_y`, `position_z`, `orientation`, `rotation0`, `rotation1`, `rotation2`, `rotation3`, `spawntimesecs`, `animprogress`, `state`) VALUES
(5, 185292, 547, 3, 1, -297.0662, -459.9854, 3.035661, 0.1047193, 0, 0, 0, 1, 7200, 255, 1), -- Skar'this's Prison
(78, 182094, 547, 3, 1, -192.2968, -799.3084, 43.80826, 5.98648, 0, 0, 0, 1, 7200, 255, 1); -- Cage
