...
UPDATE `quest_template` SET `RewardMoneyMaxLevel`=1200, `Objectives`='Keristrasza vous demande de lui parler quand vous serez $gprêt:prête; à préparer la confrontation avec Malygos.$b$bSi vous perdez votre Prison arcanique améliorée, parlez à Raelorasz au Bouclier Transitus.' WHERE `Id`=11946; -- Keristrasza
...
UPDATE `quest_template` SET `RewardMoneyMaxLevel`=2640, `Objectives`='Présentez-vous au Maire Charlton Connisport à Surwich dans les Terres Foudroyées.' WHERE `Id`=26175; -- Surwich
