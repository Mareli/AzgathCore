--
UPDATE `creature_template` SET `difficulty_entry_1`=57437, `difficulty_entry_2`=57438, `difficulty_entry_3`=57439 WHERE `entry`=56231;
UPDATE `creature_template` SET `difficulty_entry_1`=57434, `difficulty_entry_2`=57435, `difficulty_entry_3`=57436 WHERE `entry`=56265;
UPDATE `creature_template` SET `difficulty_entry_1`=57374, `difficulty_entry_2`=57375, `difficulty_entry_3`=57376 WHERE `entry`=55863;
UPDATE `creature_template` SET `difficulty_entry_1`=57368, `difficulty_entry_2`=57369, `difficulty_entry_3`=57370 WHERE `entry`=55865;
UPDATE `creature_template` SET `difficulty_entry_1`=57365, `difficulty_entry_2`=57366, `difficulty_entry_3`=57367 WHERE `entry`=55866;
UPDATE `creature_template` SET `difficulty_entry_1`=57362, `difficulty_entry_2`=57363, `difficulty_entry_3`=57364 WHERE `entry`=55867;
UPDATE `creature_template` SET `difficulty_entry_1`=57359, `difficulty_entry_2`=57360, `difficulty_entry_3`=57361 WHERE `entry`=55862;
...
UPDATE `creature_template` SET `faction`=2041 WHERE `entry`=57472;

UPDATE `creature_template` SET `npcflag`=`npcflag`|3 WHERE `entry`=57481;

UPDATE `creature_template` SET `unit_class`=2 WHERE `entry`=57955;
UPDATE `creature_template` SET `unit_class`=2 WHERE `entry`=58250;
UPDATE `creature_template` SET `unit_class`=2 WHERE `entry`=58251;
UPDATE `creature_template` SET `unit_class`=2 WHERE `entry`=57956;

UPDATE `creature_template` SET `unit_flags2`=`unit_flags2`|526336 WHERE `entry`=55866;
UPDATE `creature_template` SET `unit_flags2`=`unit_flags2`|526336 WHERE `entry`=55865;
UPDATE `creature_template` SET `unit_flags2`=`unit_flags2`|526336 WHERE `entry`=55863;
UPDATE `creature_template` SET `unit_flags2`=`unit_flags2`|526336 WHERE `entry`=55867;

UPDATE `creature_template` SET `unit_flags2`=`unit_flags2`|524288 WHERE `entry`=57430;
UPDATE `creature_template` SET `unit_flags2`=`unit_flags2`|524288 WHERE `entry`=57427;

UPDATE `creature_template` SET `unit_flags2`=`unit_flags2`|524288 WHERE `entry`=57359;
UPDATE `creature_template` SET `unit_flags2`=`unit_flags2`|524288 WHERE `entry`=57360;
UPDATE `creature_template` SET `unit_flags2`=`unit_flags2`|524288 WHERE `entry`=57361;
