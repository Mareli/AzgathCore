...
-- Areatrigger Portal Horde
delete from `areatrigger_teleport` where `id` in (-68);
insert into `areatrigger_teleport` (`Id`,`PortLocID`,`Name`) values
(-68,6580,'The MotherLode Entrance Target');

delete from `areatrigger` where `guid` in (68);
insert into `areatrigger` values
(68,100007,1642,1,-2001.02,967.502,6.26686,'');
...
-- gob add 252247 (Portail instance Alliance)
-- gob add 252248 (Portail instance Horde)

-- Table world_safe_locs (ID/PortLocID)
